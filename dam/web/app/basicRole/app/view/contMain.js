...
Ext.define('basicRole.view.contMain', {
                            ...
                            items: [
                                {
                                    ...
                                    html: '<div class="resource-row header-style">     <div class="role-col-main">ROL / DESCRIPCIÓN</div>     <div class="col-actions">ACCIONES</div> </div>'
                                },
                                {
                                    xtype: 'dataview',
                                    id: 'dataViewUser',
                                    ...
                                    itemTpl: [
                                        ...
                                        '        </div>',
                                        '        ',
                                        '        <div class="role-code-line">',
                                        '            Code: <span class="role-code">{code}</span>',
                                        '        </div>',
                                        '',
                                        '        <div class="role-desc" title="{description}">',
                                        '            {description}',
                                        '        </div>',
                                        '    </div>',
                                        '',
                                        '    <div class="col-actions">',
                                        '        <div class="action-btn edit" data-action="edit" title="Editar rol">',
    ...
    showForm: function() {
        var contUser     = Ext.getCmp('contUser');
        var toolbarMain  = Ext.getCmp('toolbarMain');
        var lblRoleTitle = Ext.getCmp('lblRoleTitle');
