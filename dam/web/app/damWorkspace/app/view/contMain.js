...
Ext.define('damWorkspace.view.contMain', {
    ...
    buildTabPanelFromTabs: function(tabs, node) {
        ...
        // function openUploadAssetDialog(cfg) - Sirve para abrir el modal para agregar imagenes
        // Se movio a una función independiente para simplificar la lógica de esta ventana

        // Función que srive para crear un store para los assets
                    ...
                    items: [
                        ...
                        // Boton para agregar archivos
                        {
                            ...
                            handler: function(btn){
                                ...
                                // Obtener la ventana como referencia
                                var contMain = Ext.getCmp('contMain');
                                console.log('contMain:', contMain);
                                console.log('openUploadAssetDialog:', contMain && contMain.openUploadAssetDialog);

                                contMain.openUploadAssetDialog({
    ...
    openUploadAssetDialog: function(cfg) {
        cfg = cfg || {};
                        ...
                        Ext.Ajax.request({
                            ...
                            success: function(response) {
                                ...
                                jsDam.toast({
                                    type: 'success',
                                    title: 'Éxito',
                                    message: (jsonData && jsonData.message) || 'Archivo subido correctamente.'
                                });
